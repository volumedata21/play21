...
export const CheckCircleIcon = ({ checked }: { checked?: boolean }) => (
    <svg className={`w-6 h-6 ${checked ? 'text-brand-primary fill-brand-primary' : 'text-white'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor">
        {checked ? (
             <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" stroke="none" />
        ) : (
...
export const NextVideoIcon = () => (
    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z"/></svg>
);

export const PrevVideoIcon = () => (
    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M6 6h2v12H6V6zm3.5 6l8.5 6V6l-8.5 6z"/></svg>
);
...
export const CCIcon = () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2 4h20v16H2V4zm4 4h4v8H6V8zm8 0h4v8h-4V8z" /></svg>
);
...
export const LoopIcon = () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 21v-5h5" />
    </svg>
);
