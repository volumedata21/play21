        ...
        <div className="p-4 flex flex-col gap-1">
          ...
          <div 
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer transition-all duration-200 group ${
              viewState === ViewState.HOME && selectedFolder === null
          ...
          <div className="flex flex-col gap-1">
              ...
              {playlists.map(playlist => (
                   ...
                   className={`flex items-center gap-3 px-4 py-2.5 rounded-xl cursor-pointer transition-all duration-200 truncate group ${
                     viewState === ViewState.PLAYLIST && selectedPlaylistId === playlist.id
